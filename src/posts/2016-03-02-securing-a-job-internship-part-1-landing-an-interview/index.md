...
tags:
  - advice
eleventyComputed:
  image: "{{ 'professional-cat.jpg' | media(page) }}"
---
...
{% responsiveImage 'cat-computer.gif', 'Cat using a computer', page %}{.width-sm}
...
{% responsiveImage 'dog-boss.jpg', 'Dog wearing glasses with a mug that says The Boss', page %}{.width-sm}
...
{% responsiveImage 'cat-computer-2.jpg', 'A fluffy cat using a computer', page %}{.width-sm}
...
{% responsiveImage 'dog-tie.jpg', 'Dog wearing glasses and tie', page %}{.width-sm}
